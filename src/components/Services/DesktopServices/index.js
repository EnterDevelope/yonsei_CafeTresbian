  ...
  return (
    <section id="services" className={styles.servicesContainer}>
      ...
      <div className={styles.serviceCardsContainer}>
        {/* 케이터링 서비스 카드 */}
        <div className={`${styles.serviceCard} ${styles.cateringCard}`}> 
          <div className={styles.serviceContent}>
            <h3 className={styles.serviceTitle}>
              케이터링 서비스
            </h3>
            <p className={styles.serviceDesc}>
              동아리 모임, 학과 세미나, 스터디 그룹 등 다양한 행사의 규모와 성격에 맞춰 최적의 메뉴를 구성해 드립니다. 신선한 재료로 만든 맛있는 디저트와 음료로 행사의 품격을 높여보세요.
            </p>
            <button 
        ...
        <div className={`${styles.serviceCard} ${styles.togoCard}`} id="togo-service-card"> 
          <div className={styles.serviceContent}>
            ...
            <p className={styles.serviceDesc}>
              바쁜 학생과 교직원을 위해 준비했습니다. 미리 주문하고 원하는 시간에 간편하게 픽업하세요. 샌드위치, 샐러드, 음료 등 든든하고 맛있는 메뉴를 가방에 쏙 담아드립니다.
            </p>
            <button 
