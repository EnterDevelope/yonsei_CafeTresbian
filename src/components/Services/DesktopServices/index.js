  ...
  return (
    <section id="services" className={styles.servicesContainer}>
      ...
      <div className={styles.serviceCardsContainer}>
        {/* 케이터링 서비스 카드 */}
        <div className={`${styles.serviceCard} ${styles.cateringCard}`} id="catering-service-card"> 
          <div className={styles.serviceContent}>
            <h3 className={styles.serviceTitle}>
              케이터링 서비스
            </h3>
            <p className={styles.serviceDesc}>
              동아리 모임, 학과 세미나, 스터디 그룹 등 다양한 행사의 규모와 성격에 맞춘 케이터링을 신청해보세요. 신선한 재료로 만든 맛있는 디저트와 음료로 행사의 퀄리티를 높여드립니다.
            </p>
            <button 
        ...
        <div className={`${styles.serviceCard} ${styles.togoCard}`} id="togo-service-card"> 
          <div className={styles.serviceContent}>
            <h3 className={styles.serviceTitle}>
              To-go Bag 서비스 (매장에 직접 문의)
            </h3>
            <p className={styles.serviceDesc}>
              바쁜 학생과 교직원을 위해 준비했습니다. 간편하게 픽업해가 실 수 있도록 포장해드립니다.
            </p>
            <button 
